...
- (NSUInteger)loadSoundFromFile:(NSString*)file ext:(NSString*)ext withLoop:(bool)loops {
    ...
    NSString *thePath = [[NSBundle mainBundle] pathForResource:file
                                                        ofType:ext];
    CFStringRef ref = (__bridge CFStringRef)thePath;
    
//    NSString *anObjCString = (NSString *) anCFString;
//    CFStringRef anCFString = (CFStringRef) anObjCString; 
    ...
    //NSURL *nsurl = [NSURL fileURLWithPath:[bundle pathForResource:file ofType:ext]];
    //CFURLRef fileURL = nsurl;//(CFURLRef) nsurl.baseURL;
